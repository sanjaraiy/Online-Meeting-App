...
function ScheduledMeeting() {
 ...
 useEffect(() => {
  ...
  <TabsContent value="upcoming"><ScheduledMeetingList meetingList={filterMeetingList('upcoming')}></ScheduledMeetingList></TabsContent>
  <TabsContent value="expired"><ScheduledMeetingList meetingList={filterMeetingList('expired')}></ScheduledMeetingList></TabsContent>
</Tabs>
